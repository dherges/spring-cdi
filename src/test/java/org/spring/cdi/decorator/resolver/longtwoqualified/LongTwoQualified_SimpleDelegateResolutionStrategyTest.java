...
public class LongTwoQualified_SimpleDelegateResolutionStrategyTest {
	...
	public void testChaining_MyDecoratorLeadsToMyDelegate() {
		...
		try {
			decoratorInfo = new DecoratorInfo("longTwoQualified_MyDecorator", beanFactory.getBeanDefinition("longTwoQualified_MyDecorator"), Class.forName("org.spring.cdi.decorator.resolver.longtwoqualified.LongTwoQualified_MyDecorator"));
	...
	public void testChaining_MyDecorator2LeadsToMyDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("longTwoQualified_MyDecorator2", beanFactory.getBeanDefinition("longTwoQualified_MyDecorator2"), Class.forName("org.spring.cdi.decorator.resolver.longtwoqualified.LongTwoQualified_MyDecorator2"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
	...
	public void testChaining_AnotherDecoratorLeadsToAnotherDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("longTwoQualified_AnotherDecorator", beanFactory.getBeanDefinition("longTwoQualified_AnotherDecorator"), Class.forName("org.spring.cdi.decorator.resolver.longtwoqualified.LongTwoQualified_AnotherDecorator"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
	...
	public void testChaining_AnotherDecorator2LeadsToAnotherDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("longTwoQualified_AnotherDecorator2", beanFactory.getBeanDefinition("longTwoQualified_AnotherDecorator2"), Class.forName("org.spring.cdi.decorator.resolver.longtwoqualified.LongTwoQualified_AnotherDecorator2"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
