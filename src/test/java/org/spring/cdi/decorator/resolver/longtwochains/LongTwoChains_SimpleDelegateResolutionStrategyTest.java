...
public class LongTwoChains_SimpleDelegateResolutionStrategyTest {
	...
	public void testChaining_MyDecorator3LeadsToMyDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("longSingleChain_MyDecorator3", beanFactory.getBeanDefinition("longSingleChain_MyDecorator3"), Class.forName("org.spring.cdi.decorator.resolver.longsinglechain.LongSingleChain_MyDecorator3"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
	...
	public void testChaining_AnotherDecoratorLeadsToAnotherDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("longTwoChains_AnotherDecorator", beanFactory.getBeanDefinition("longTwoChains_AnotherDecorator"), Class.forName("org.spring.cdi.decorator.resolver.longtwochains.LongTwoChains_AnotherDecorator"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
	...
	public void testChaining_AnotherDecorator2LeadsToAnotherDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("longTwoChains_AnotherDecorator2", beanFactory.getBeanDefinition("longTwoChains_AnotherDecorator2"), Class.forName("org.spring.cdi.decorator.resolver.longtwochains.LongTwoChains_AnotherDecorator2"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
	...
	public void testChaining_AnotherDecorator3LeadsToAnotherDelegate() {
		DecoratorInfo decoratorInfo = null;
		try {
			decoratorInfo = new DecoratorInfo("longTwoChains_AnotherDecorator3", beanFactory.getBeanDefinition("longTwoChains_AnotherDecorator3"), Class.forName("org.spring.cdi.decorator.resolver.longtwochains.LongTwoChains_AnotherDecorator3"));
		} catch (NoSuchBeanDefinitionException e) {
			TestCase.fail(e.getMessage());
		} catch (ClassNotFoundException e) {
			TestCase.fail(e.getMessage());
